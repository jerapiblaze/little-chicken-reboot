...
async function execute(interaction) {
    ...
    try {
        ...
        await interaction.editReply({ components: [executables.tools.get('buttons_cfs').buttonRow_approveSuccess(interaction.user.tag, Moment().tz("Asia/Ho_Chi_Minh").format(), `https://fb.com/${fbRes.id}/`)] });
        return 0;
    } catch(e){
